...
export function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      className={cn(
        'peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent bg-emerald-900 transition-colors data-[state=checked]:bg-lime-600',
        className,
      )}
      {...props}
    >
